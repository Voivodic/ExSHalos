...
x = exshalos.utils.Fit_Barrier(k, P, Mt, dnt, grid = None, R_max = 100000.0, Mmin = -1.0, Mmax = -1.0, Nm = 25, nd = Nd, Lc = Lc, Om0 = Om0, z = z, delta_c = -1.0, Nmin = 1, seed = 12345, x0 = barrier, verbose = False, nthreads = 1)
...
x = exshalos.mock.Generate_Halos_Box_from_Pk(k, P, nd = Nd, Lc = Lc, Om0 = Om0, z = z, k_smooth = 0.4, Nmin = 1, a = barrier[0], beta = barrier[1], alpha = barrier[2], seed = 12345, OUT_DEN = False, OUT_LPT = False, OUT_VEL = False, DO_2LPT = False, OUT_FLAG = False, verbose = False, nthreads = 1)
dnh1 = exshalos.simulation.Compute_Abundance(x["Mh"], Lc = Lc, nd = Nd)

print("Second catalogue")
x = exshalos.mock.Generate_Halos_Box_from_Pk(k, P, nd = Nd, Lc = Lc, Om0 = Om0, z = z, k_smooth = 0.4, Nmin = 1, seed = 12345, OUT_DEN = False, OUT_LPT = False, OUT_VEL = False, DO_2LPT = False, OUT_FLAG = False, verbose = False, nthreads = 1)
dnh2 = exshalos.simulation.Compute_Abundance(x["Mh"], Lc = Lc, nd = Nd)
