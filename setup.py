...
def get_include_dirs():
    ...
    include_dirs = [os.path.join(os.getcwd(), 'include'),
                    numpy.get_include(), "/usr/local/", "/usr/lib/x86_64-linux-gnu/openmpi/"]
...
if(recompile_c_modules(double_precision)):
    ...
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/spectrum", "bias.c"))
    ...
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/hod", "hod_h.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/hod", "hod.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/hod", "populate_halos.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/hod", "split_galaxies.c"))

    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/sampler", "sampler_h.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/sampler", "sampler.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/sampler", "random_generator.c"))
    touch(os.path.join(os.path.dirname(os.path.abspath(__file__)), "exshalos/sampler", "posteriors.c"))
...
spectrum = Extension("exshalos.spectrum.spectrum",
                          sources = ["exshalos/spectrum/spectrum.c", "exshalos/spectrum/spectrum_h.c", "exshalos/spectrum/gridmodule.c", "exshalos/spectrum/powermodule.c", "exshalos/spectrum/bimodule.c", "exshalos/spectrum/trimodule.c", "exshalos/spectrum/abundance.c", "exshalos/spectrum/bias.c"],
...
hod = Extension("exshalos.hod.hod",
                          sources = ["exshalos/hod/hod.c", "exshalos/hod/hod_h.c", "exshalos/hod/populate_halos.c", "exshalos/hod/split_galaxies.c"],
                          extra_compile_args = extra_compile_args,
                          extra_link_args=['-lgomp'],
                          include_dirs = include_dirs,
                          library_dirs = library_dirs,
...
sampler = Extension("exshalos.sampler.sampler",
                          sources = ["exshalos/sampler/sampler.c", "exshalos/sampler/sampler_h.c", "exshalos/sampler/random_generator.c", "exshalos/sampler/posteriors.c", "exshalos/sampler/hmc.c", "exshalos/sampler/minimization.c"],
                          extra_compile_args = extra_compile_args,
                          extra_link_args=['-lgomp'],
                          include_dirs = include_dirs,
                          library_dirs = library_dirs,
