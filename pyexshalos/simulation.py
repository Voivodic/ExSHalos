...
def Compute_Voronoi(
    ...
    """
    Compute the voronoi tesselation for the array of particles.

    :param pos: Position of the tracers.
    :type pos: numpy.ndarray
    :param nd: Number of cells per dimension for the computation of the voronoi diagram. Fiducial value: 256
    :type nd: int
    :param L: Size of the box in Mpc/h. Fiducial value: 1000.0
    :type L: float
    ...
    :return: Dictionary with the following keys
             - "vol": Ndarray with the folume of each voronoi cell
    :rtype: dict
    """
    # Check the precision and convert the arrays
    ...
    # Call the c++ function that computes the voronoi tesselation
    from .lib.finder import voronoi_compute

    voronoi = voronoi_compute(
        pos,
        np.int32(nd),
        np.int32(nd),
        np.int32(nd),
