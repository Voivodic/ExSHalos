...
static PyObject *clpt_compute(PyObject *self, PyObject *args, PyObject *kwargs){
	...
	/*Alloc the PyObjects for the output*/
    PyArrayObject *np_k = (PyArrayObject *) PyArray_ZEROS(1, dims_k, PyArray_FLOAT64, 0);
    PyArrayObject *np_P = (PyArrayObject *) PyArray_ZEROS(1, dims_k, PyArray_FLOAT64, 0);
    PyArrayObject *np_P11 = (PyArrayObject *) PyArray_ZEROS(1, dims_k, PyArray_FLOAT64, 0);

    kout = (double *) np_k->data;
	P = (double *) np_P->data;
    P11 = (double *) np_P11->data; 
